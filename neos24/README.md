...
| [`site/`](site/) | Startseite nach dem Rebranding 2026 (HTML/CSS/JS, ohne Build) mit Revolut-Checkout, Kontaktformular-Endpunkt und internem Dashboard (`site/intern/`, Rollen mit Rechtematrix, Routingmatrix als Preisquelle) — Vorlage für Layout, CSS und Navigation, die AIVA später braucht |
