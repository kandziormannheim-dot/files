...
<div class="kpi-raster">
  ...
  <div class="kpi kpi--cyan"><span class="kpi-name">Lieferantenrechnungen zu prüfen</span><strong class="kpi-wert"><?= (int) $k['lieferantenOffen'] ?></strong><span class="kpi-zusatz">Nachberechnung offen <?= e(euro((int) $k['nachberechnungOffen'])) ?> netto<?= darf('rechnungspruefung') ? ' · <a href="' . e(url('rechnungspruefung')) . '">öffnen</a>' : '' ?></span></div>
