...
| `lib/` | Gemeinsame Helfer für `intern/` und `konto/` (Maskierung, CSRF, Formate), Kundenkonten und Firmen, Versand-Kern (`versand.php`), Rechnungsprüfung (`rechnungspruefung.php`), Carrier-Schnittstelle (Stubs), NEOS-Label und Sammelrechnungen als PDF (FPDF vendored) |
