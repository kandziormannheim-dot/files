...
| `konto/` | Kundenportal für Privat- und Geschäftskunden: Sendungen mit Carrier-Vergleich und Zusatzleistungen anlegen (Revolut, Guthaben oder Rechnung), Labels als PDF, Tracking (auch öffentlich), Adressbuch je Benutzer mit Firmenfreigabe, Paketvorlagen, Sendungsimport aus CSV/XLSX, Guthaben, Retouren, Reklamationen, Belegarchiv mit PDF-Download — jeder nur seine eigenen Daten; Login per Passwort oder E-Mail-Link — siehe `konto/README.md` |
